...
export const cards: Card[] = [
  ...
  { id: 63, front: "Canter & Siegel Spam", back: "1994 incident where lawyers posted Green Card ads to every Usenet group — proving the system could be exploited for free advertising.", week: "Week 1 & 2" },
  ...
  { id: 66, front: "Voting Equality", back: "Dahl's Rule #2: When it's time to decide, every vote must count exactly the same — one person, one vote.", week: "Week 1 & 2" },
  { id: 67, front: "Enlightened Understanding", back: "Dahl's Rule #3: Citizens need access to truth and different facts to make smart choices.", week: "Week 1 & 2" },
  { id: 68, front: "Control of the Agenda", back: "Dahl's Rule #4: The people (not a king or CEO) must decide what topics are important to discuss.", week: "Week 1 & 2" },
  ...
  { id: 71, front: "Indegree (Followers)", back: "Measures POPULARITY — people are watching but not necessarily listening. Top users: CNN, Obama.", week: "Week 3" },
  ...
  { id: 95, front: "Runoff Voting", back: "If no majority in round 1, top two face a second election. Ensures majority support but causes voter fatigue.", week: "Week 5" },
  ...
  { id: 99, front: "Approval Voting", back: "Check boxes for as many candidates as you like. Simple, eliminates vote splitting, no wasted votes.", week: "Week 5" },
  ...
  { id: 102, front: "Gibbard-Satterthwaite", back: "No ranking-based voting system can guarantee voters always benefit from honest voting — every system can be gamed.", week: "Week 5" },
  ...
  { id: 110, front: "Code is Law", back: "Blockchain philosophy: rules execute exactly as coded, no human override. Bugs become \"legal\" exploits.", week: "Week 6" },
  ...
  { id: 122, front: "The Oracle Problem", back: "Prediction markets need a trusted source to verify actual outcomes — disagreements can break the system.", week: "Week 7 & 8" },
  ...
  { id: 124, front: "Why Quadratic?", back: "Linear cost = dictatorship of intense. Steep cost = everyone casts 1 vote. Quadratic = optimal sweet spot.", week: "Week 7 & 8" },
